-- TODO: automatically show signature help, or at least make an easier keybinding
-- TODO: properly figure out/set up debugging
--[[
...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        -- clangd = {
        --   cmd = {
        --     -- '/Users/tibibit/utils/clangd', -- 2024-07-05 clangd 18.1.3 has issues
        --     -- '/Users/tibibit/.local/share/nvim/mason/bin/clangd',
        --     -- '--log=verbose',
        --    '/Users/tibibit/repos/llvm-project/build/bin/clangd'  -- testing clangd patch
        --   },
        -- },
        -- gopls = {},
        -- pyright = {},
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    opts = { signs = false, keywords = { NTS = { color = 'error' } } },
  },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- require('mini.surround').setup({mappings = {add = }})
