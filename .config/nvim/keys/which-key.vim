...
let mapleader=' '
let maplocalleader=','
" adapted from https://github.com/ChristianChiarulli/nvim/blob/master/keys/which-key.vim
...
" Single mappings
" :Comment must be remapped via vim for commenting multiple lines to work
" nnoremap <silent> <leader>/ :Comment<CR>
...
let g:which_key_map.t = {
    \ 'name': '+latex' ,
    \ 'b' : [':CocCommand latex.Build'          , 'build'],
    \ 's' : [':CocCommand latex.ForwardSearch'  , 'forward search'],
  \ }
